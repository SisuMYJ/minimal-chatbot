      ...
      >
        ...
        >
          {message.role === 'assistant' && (
            <div className="size-9 flex items-center rounded-full justify-center shrink-0 border border-primary/15 bg-card/80 text-primary shadow-sm ring-4 ring-[#8fd3e8]/20">
