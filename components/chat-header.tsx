...
function PureChatHeader({
  ...
  return (
    <header className="sticky top-0 z-20 mx-2 mt-2 flex items-center gap-2 rounded-[1.6rem] border border-border/70 bg-card/78 px-3 py-2 shadow-[0_18px_60px_-45px_rgba(55,43,31,0.55)] backdrop-blur-xl">
      <SidebarToggle />
